...
mode=`grep -n -m 1 '\<TXInvert\>' /home/pi/MMDVMHost/MMDVMDMR2YSF.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/pi/MMDVMHost/MMDVMDMR2YSF.ini;
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyAMA0" /home/pi/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/pi/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM1" /home/pi/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/pi/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
master1=`echo "$master1" | tr [:upper:] [:lower:]`
                          ...
                          sed -i "$linea Address=$master1" /home/pi/MMDVMHost/MMDVMDMR2YSF.ini
