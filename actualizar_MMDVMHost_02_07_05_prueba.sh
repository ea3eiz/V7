...
echo  "\33[1;36m   3)${BLANCO} Instalación limpia de MMDVMHost\33[1;33m"
...
#Modem 
mode=`grep -n -m 1 "^Port=" /home/pi/Downloads/MMDVM.ini`
var1=`grep -m 1 "^Port=" /home/pi/Downloads/MMDVM.ini`
buscar=":"
caracteres=`expr index $mode $buscar`
caracteres_linea=`expr $caracteres - 1`
numero_linea_port=`expr substr $mode 1 $caracteres_linea`

1mode=`grep -n -m 1 "^Port=" /home/pi/MMDVMHost/MMDVM.ini`
1buscar=":"
1caracteres=`expr index $1mode $1buscar`
1caracteres_linea=`expr $1caracteres - 1`
1numero_linea_port=`expr substr $1mode 1 $1caracteres_linea`
1modem_letra=c
1modem_linea_sed=$1numero_linea_port$1modem_letra
sed -i "$1modem_linea_sed $var1" /home/pi/MMDVMHost/MMDVM.ini
...
clear
                    echo " ******************************************************************"
                    echo " \33[1;31m* Si instalas MMDVMhost desde esta opción, perderás todas las    *"
                    echo " \33[1;31m* configuraciones                                                *"
                    echo " * Tendrás que volver a configurar todos los MMDVM                *"
                    echo " \33[1;32m******************************************************************"
                    echo "\33[1;33m"
