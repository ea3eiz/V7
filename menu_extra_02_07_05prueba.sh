...
echo "\33[1;36m  2a)${AMARILLO} ACTUALIZAR DMR2YSF"
echo "\33[1;36m  2b)${AMARILLO} ACTUALIZAR DMR2NXDN"
echo "\33[1;36m  2c)${AMARILLO} ACTUALIZAR YSF2DMR"
echo ""
...
clear
                        ...
                        #comprueba si la versión a camviado
                        version_DMR2YSF_actual=$(awk "NR==23" /home/pi/DMR2YSF/Version.h)
                        version_DMR2YSF_instalada=$(awk "NR==2" /home/pi/versiones_YSF2DMR_DMR2YSF_DMR2NXDN.ini)
                        ...
                        sed -i "2c $version_DMR2YSF_actual" /home/pi/versiones_YSF2DMR_DMR2YSF_DMR2NXDN.ini
                        echo "${ROJO}"
                        echo "*******************************************"
...
clear
                        ...
                        cp /home/pi/DMR2NXDN/DMR2NXDN.ini /home/pi
                        cp /home/pi/NXDNClients/NXDNGateway/NXDNGateway.ini /home/pi
                        ...
                        version_DMR2NXDN_instalada=$(awk "NR==3" /home/pi/versiones_YSF2DMR_DMR2YSF_DMR2NXDN.ini)
                        ...
                        mv /home/pi/DMR2NXDN.ini /home/pi/DMR2NXDN
                        mv /home/pi/NXDNGateway.ini /home/pi/NXDNClients/NXDNGateway

                        
                        #la versión es nueva la instalamos y ponemos la version.h en versiones_YSF2DMR_DMR2YSF_DMR2NXDN.ini
                        else
                        sed -i "3c $version_DMR2NXDN_actual" /home/pi/versiones_YSF2DMR_DMR2YSF_DMR2NXDN.ini
                        echo "${ROJO}"
                        echo "*******************************************"
...
clear                     
                        ...
                        version_YSF2DMR_instalada=$(awk "NR==1" /home/pi/versiones_YSF2DMR_DMR2YSF_DMR2NXDN.ini)
                        ...
                        sed -i "1c $version_YSF2DMR_actual" /home/pi/versiones_YSF2DMR_DMR2YSF_DMR2NXDN.ini
                        echo "${ROJO}"
                        echo "*******************************************"
...
clear
                        ...
                        case $ejecutar1 in
                              ...
                              sudo rm -R /home/pi/$SCRIPTS
                              sleep 5
                        cd /home/pi
                        git clone https://github.com/ea3eiz/$SCRIPTS
                        cp -R /home/pi/$SCRIPTS/Desktop /home/pi/
