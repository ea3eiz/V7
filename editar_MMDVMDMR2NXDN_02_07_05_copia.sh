...
mode=`grep -n -m 1 '\<TXInvert\>' /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini;
...
#var1=`grep -m 1 "\[Nextion\]" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini`
buscar=":"
...
echo ""
idd=$(awk "NR==9" /home/pi/DMR2NXDN/DMR2NXDN.ini)
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyAMA0" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM1" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del Id: \33[1;33m${idd#*=}\33[1;37m"
           	          read -p 'Introduce un ID válido ' miid
                          ...
                          sed -i "9c Id=$miid" /home/pi/DMR2NXDN/DMR2NXDN.ini
...
master1=`echo "$master1" | tr [:upper:] [:lower:]`
                          ...
                          sed -i "$linea Address=$master1" /home/pi/MMDVMHost/MMDVMDMR2NXDN.ini
