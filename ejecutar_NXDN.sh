...
sed -i "4c Exec=sh -c 'cd /home/pi/$SCRIPTS_version;lxterminal --geometry=72x15 -e sudo sh cerrar_NXDN.sh'" /home/pi/Abrir_DMR2NXDN.desktop
...
sudo lxterminal --geometry=80x12 -e ./MMDVMNXDN MMDVMDMR2NXDN.ini &
