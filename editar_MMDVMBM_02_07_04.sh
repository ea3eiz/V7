...
master=`grep -n -m 1 "^Address=" /home/pi/MMDVMHost/MMDVMBM.ini_copia`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
master=`grep -n -m 1 "^Address=" /home/pi/MMDVMHost/MMDVMBM.ini_copia2`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
master=`grep -n -m 1 "^Address=" /home/pi/MMDVMHost/MMDVMBM.ini_copia3`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
indi=$(awk "NR==2" /home/pi/MMDVMHost/MMDVMBM.ini)
sed -i "1c $indi" /home/pi/info_panel_control.ini
sed -i "40c $indicativo" /home/pi/info_panel_control.ini #escribe solo el indicativo
...
master1=`echo "$master1" | tr [:upper:] [:lower:]`
                          ...
                          sed -i "$linea_master Address=$master1" /home/pi/MMDVMHost/MMDVMBM.ini
