...
master=`grep -n -m 1 "^Address=" /home/pi/MMDVMHost/MMDVM.ini_copia`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
master=`grep -n -m 1 "^Address=" /home/pi/MMDVMHost/MMDVM.ini_copia2`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
master=`grep -n -m 1 "^Address=" /home/pi/MMDVMHost/MMDVM.ini_copia3`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
do
                          ...
                          sed -i "$numero_linea_port Port=/dev/ttyAMA0" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyACM0" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyACM1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyUSB0" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
master1=`echo "$master1" | tr [:upper:] [:lower:]`
                          ...
                          sed -i "$linea_master Address=$master1" /home/pi/MMDVMHost/MMDVM.ini
