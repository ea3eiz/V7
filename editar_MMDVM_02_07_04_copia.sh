...
clear
                  ...
                  master=$(awk "NR==147" /home/pi/MMDVMHost/MMDVM.ini)
...
mode=`grep -n -m 1 '\<TXInvert\>' /home/pi/MMDVMHost/MMDVM.ini`
...
letra=p
linea2=$linea$letra
var99= sed -n $linea2  /home/pi/MMDVMHost/MMDVM.ini;

echo -n "\33[1;36m  10)\33[0m Modificar ID          - \33[1;33m"
idd=`grep -n "Id=" /home/pi/MMDVMHost/MMDVM.ini`
...
var100port= sed -n $linea2port  /home/pi/MMDVMHost/MMDVM.ini;

echo -n "\33[1;36m  13)\33[0m Modificar Password    - \33[1;33m"
pas=`grep -n '\<Password\>' /home/pi/MMDVMHost/MMDVM.ini`
pas1=`expr substr $pas 5 30`
echo "$pas1"

echo -n "\33[1;36m  14)\33[0m Modificar TXInvert    - \33[1;33m"
txinv=`grep -n '\<TXInvert\>' /home/pi/MMDVMHost/MMDVM.ini`
txinv1=`expr substr $txinv 4 30`
echo -n "$txinv1"

echo -n "\33[1;36m      a)\33[0m D-STAR      - \33[1;33m"
dstar=`grep -n "\[D-Star\]" /home/pi/MMDVMHost/MMDVM.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valo= sed -n $numero_linea_dstar_letrap  /home/pi/MMDVMHost/MMDVM.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  15)\33[0m Modificar RXLevel     - \33[1;33m"
rx=`grep -n '\<RXLevel\>' /home/pi/MMDVMHost/MMDVM.ini`
rx1=`expr substr $rx 4 30`
echo -n "$rx1"

echo -n "\33[1;36m      b)\33[0m DMR         - \33[1;33m"
dmr=`grep -n "\[DMR\]" /home/pi/MMDVMHost/MMDVM.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_dmr_letrap  /home/pi/MMDVMHost/MMDVM.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  16)\33[0m Modificar TXLevel     - \33[1;33m"
tx=`grep -n -m 1 '\<TXLevel\>' /home/pi/MMDVMHost/MMDVM.ini`
tx1=`expr substr $tx 4 30`
echo -n "$tx1"

echo -n "\33[1;36m      c)\33[0m FUSION      - \33[1;33m"
fusion=`grep -n "LowDeviation" /home/pi/MMDVMHost/MMDVM.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_fusion_letrap  /home/pi/MMDVMHost/MMDVM.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  17)\33[0m Modificar Duplex      - \33[1;33m"
dup=`grep -n -m 1 '\<Duplex\>' /home/pi/MMDVMHost/MMDVM.ini`
dup1=`expr substr $dup 3 30`
echo -n "$dup1"


echo -n "\33[1;36m        d)\33[0m P25         - \33[1;33m"
p25=`grep -n "\[P25\]" /home/pi/MMDVMHost/MMDVM.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_p25_letrap  /home/pi/MMDVMHost/MMDVM.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  18)\33[0m Modificar TXHang      - \33[1;33m"
txh=`grep -n -m 1 '\<TXHang\>' /home/pi/MMDVMHost/MMDVM.ini`
txh1=`expr substr $txh 5 30`
echo -n "$txh1"

echo -n "\33[1;36m        e)\33[0m Baliza      - \33[1;33m"
cw= sed -n "31p"  /home/pi/MMDVMHost/MMDVM.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  19)\33[0m Modificar Tramas      - \33[1;33m"
lg=`grep -n -m 1 '\<DisplayLevel\>' /home/pi/MMDVMHost/MMDVM.ini`
lg1=`expr substr $lg 4 30`
echo -n "$lg1"

echo -n "\33[1;36m  f)\33[0m RFModeHang  - \33[1;33m"
modehang=`grep -n -m 1 -c '\<RFModeHang\>' /home/pi/MMDVMHost/MMDVM.ini`
if [ $modehang = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
modehang=`grep -n -m 1 '\<RFModeHang\>' /home/pi/MMDVMHost/MMDVM.ini`
modehang1=`expr substr $modehang 3 30`
echo "$modehang1"
fi

echo -n "\33[1;36m  20)\33[0m Modificar Slot1       - \33[1;33m"
sl=`grep -n -m 1 '\<Slot1\>' /home/pi/MMDVMHost/MMDVM.ini`
sl1=`expr substr $sl 5 30`
echo -n "$sl1"

echo -n "\33[1;36m         g)\33[0m Timeout     - \33[1;33m"
timeo=`grep -n -m 1 -c '\<Timeout\>' /home/pi/MMDVMHost/MMDVM.ini`
if [ $timeo = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
timeo=`grep -n -m 1 '\<Timeout\>' /home/pi/MMDVMHost/MMDVM.ini`
timeo1=`expr substr $timeo 3 30`
echo "$timeo1"
fi

echo -n "\33[1;36m  21)\33[0m Tipo Pantalla Display - \33[1;33m"
Display=`grep -n -m 1 -c '\<Display\>' /home/pi/MMDVMHost/MMDVM.ini`
if [ $Display = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
Display=`grep -n -m 1 '\<Display\>' /home/pi/MMDVMHost/MMDVM.ini`
Display1=`expr substr $Display 3 30`
echo -n "$Display1"
fi

var=`grep -n -m 1 "\[Nextion\]" /home/pi/MMDVMHost/MMDVM.ini`
#var1=`grep -m 1 "\[Nextion\]" /home/pi/MMDVMHost/MMDVM.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 2` # y le suma uno qudando coomo: (75)
MODEMNEXTION=$(awk "NR==$numero_linea" /home/pi/MMDVMHost/MMDVM.ini)
letra=c
...
ScreenLayout=`grep -n -m 1 -c '\<ScreenLayout\>' /home/pi/MMDVMHost/MMDVM.ini`
if [ $ScreenLayout = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
ScreenLayout=`grep -n -m 1 '\<ScreenLayout\>' /home/pi/MMDVMHost/MMDVM.ini`
ScreenLayout1=`expr substr $ScreenLayout 5 30`
echo -n "$ScreenLayout1"
fi

var=`grep -n -m 1 "\[NXDN\]" /home/pi/MMDVMHost/MMDVM.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
NXDN=$(awk "NR==$numero_linea" /home/pi/MMDVMHost/MMDVM.ini)
letra=c
...
Brightness=$(awk "NR==$numero_linea" /home/pi/MMDVMHost/MMDVM.ini)
letra=c
linea_sed_Brightness=$numero_linea$letra
echo -n "  ${CIAN}23) ${GRIS}Brillo Display Nextion- ${AMARILLO}$Brightness"

# j) POCSAG Enable=
var=`grep -n -m 1 "\[POCSAG\]" /home/pi/MMDVMHost/MMDVM.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
POCSAG=$(awk "NR==$numero_linea" /home/pi/MMDVMHost/MMDVM.ini)
letra=c
...
var300port= sed -n $linea22port  /home/pi/MMDVMHost/MMDVM.ini;
...
pluscopia=`grep -n -m 1 '\<Address\>' /home/pi/MMDVMHost/MMDVM.ini_copia`
...
pluscopia2=`grep -n -m 1 '\<Address\>' /home/pi/MMDVMHost/MMDVM.ini_copia2`
...
pluscopia3=`grep -n -m 1 '\<Address\>' /home/pi/MMDVMHost/MMDVM.ini_copia3`
pluscopia3=`expr substr $pluscopia3 13 40`
echo "$pluscopia3"

echo ""
echo "\33[1;36m  35)\33[1;31m Recuperar el fichero original MMDVM.ini\33[1;33m"
...
indicativo=`echo "$indicativo" | tr [:lower:] [:upper:]`
                          ...
                          sed -i "$linea Callsign=$indicativo" /home/pi/MMDVMHost/MMDVM.ini
...
echo "Valor actual del RXFrequency: \33[1;33m${rxf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce RXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                              sed -i "$linea RXFrequency=$var2" /home/pi/MMDVMHost/MMDVM.ini
...
echo "Valor actual del TXFrequency: \33[1;33m${txf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce TXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXFrequency=$var2" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Ciudad: \33[1;33m${loca#*=}\33[1;37m"
              ...
              sed -i "$linea Location=$loc1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de  la  URL   Web: \33[1;33m${url#*=}\33[1;37m"
			  ...
			  ur1=`echo "$ur1" | tr -d '[[:space:]]'`
                          sed -i "$linea URL=$ur1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=/dev/ttyAMA0" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM0" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyACM1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          linea4=$linea33$letra1
                          sed -i "$linea4 Port=/dev/ttyUSB0" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del Id: \33[1;33m${idd#*=}\33[1;37m"
           	          read -p 'Introduce un ID válido ' miid
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Id=$miid" /home/pi/MMDVMHost/MMDVM.ini
...
master1=`echo "$master1" | tr [:upper:] [:lower:]`
                          ...
                          sed -i "$linea Address=$master1" /home/pi/MMDVMHost/MMDVM.ini

master=$(awk "NR==139" /home/pi/MMDVMHost/MMDVM.ini)
sed -i "9c $master" /home/pi/info_panel_control.ini
...
do
        ...
        [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=$miid" /home/pi/MMDVMHost/MMDVM.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "   Valor actual del Password: \33[1;33m${pas#*=}\33[1;37m"
           	          read -p '   Introduce el password que corresponda: ' pas1
                          ...
                          sed -i "$linea Password=$pas1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  TXInvert: \33[1;33m${txinv#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXInvert=$txinv1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  RXLevel : \33[1;33m${rx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=45 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea RXLevel=$var2" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  TXLevel : \33[1;33m${tx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=50 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXLevel=$var2" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Duplex: \33[1;33m${dup#*=}\33[1;37m"
           	          read -p 'Para un repetidor Duplex=1 Para un DVMEGA Duplex=0: ' dup1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Duplex=$dup1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del TXHang: \33[1;33m${txh#*=}\33[1;37m"
           	          read -p 'Para un repetidor TXHang=4 Para un DVMEGA TXHang=0: ' txh1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXHang=$txh1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del DisplayLevel: \33[1;33m${lg#*=}\33[1;37m"
           	     read -p 'Para visualizar tramas seguidas introduce 1, para una sola trama introduce 2:' lg1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea DisplayLevel=$lg1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
while true
do
sl=`grep -n -m 1 -c '\<Slot1\>' /home/pi/MMDVMHost/MMDVM.ini`
if [ $sl = 0 ]; then
...
echo "Valor actual del Slot1=: \33[1;33m${sl#*=}\33[1;37m"
           	          read -p 'Para DVMEGA Modificar el valor del Slot1=0: ' V
			              ...
			              [sS]* ) echo ""
			              V=`echo "$V" | tr -d '[[:space:]]'`			  
                          sed -i "$linea Slot1=$V" /home/pi/MMDVMHost/MMDVM.ini             
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Display=: \33[1;33m${Display1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Display=$V" /home/pi/MMDVMHost/MMDVM.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del ScreenLayout=: \33[1;33m${ScreenLayout1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea ScreenLayout=$V" /home/pi/MMDVMHost/MMDVM.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
                          ...
                          [sS]* ) echo ""
                          V=`echo "$V" | tr -d '[[:space:]]'`      
                          sed -i "$linea_sed_Brightness Brightness=$V" /home/pi/MMDVMHost/MMDVM.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
modu1=`echo "$modu1" | tr [:lower:] [:upper:]`
                          ...
                          sed -i "$linea Module=$modu1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dstar_letrap  /home/pi/MMDVMHost/MMDVM.ini;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_dstar_letrac Enable=$dmrac1" /home/pi/MMDVMHost/MMDVM.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dmr_letrap  /home/pi/MMDVMHost/MMDVM.ini;
           	              read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
			                    [sS]* ) echo ""
                          sed -i "$numero_linea_dmr_letrac Enable=$dmrac1" /home/pi/MMDVMHost/MMDVM.ini
			                    break;;
			                    [nN]* ) echo ""
			                    break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_fusion_letrap  /home/pi/MMDVMHost/MMDVM.ini;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_fusion_letrac Enable=$dmrac1" /home/pi/MMDVMHost/MMDVM.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_p25_letrap  /home/pi/MMDVMHost/MMDVM.ini;
                          read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_p25_letrac Enable=$dmrac1" /home/pi/MMDVMHost/MMDVM.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor actual del RFModeHang = : \33[1;33m${modehang1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea RFModeHang=$V" /home/pi/MMDVMHost/MMDVM.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del Timeout = : \33[1;33m${timeo1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Timeout=$V" /home/pi/MMDVMHost/MMDVM.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor del Port: \33[1;33m$MODEMNEXTION"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_MN Port=$lat1" /home/pi/MMDVMHost/MMDVM.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor actual NXDN: \33[1;33m$NXDN"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_NXDN Enable=$NXDN1" /home/pi/MMDVMHost/MMDVM.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_POCSAG Enable=$POCSAG1" /home/pi/MMDVMHost/MMDVM.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor de la Latitud: \33[1;33m${lat#*=}\33[1;37m"
           	          read -p 'Introduce la Latitud ' lat1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Latitude=$lat1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Longitud: \33[1;33m${long#*=}\33[1;37m"
           	          read -p 'Introduce la Longitud ' long1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Longitude=$long1" /home/pi/MMDVMHost/MMDVM.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
#echo "Valor  actual del  RXInvert: \33[1;33m${rxinv#*=}\33[1;37m"
                     #read -p 'Valor óptimo para Motorola=0 para otras=1 : ' rxinv11
                         ...
                         #then
                          ...
                          #case $actualizar in
        #[sS]* ) echo ""
                          #sed -i "$linea RXInvert=$rxinv11" /home/pi/MMDVMHost/MMDVM.ini
        #break;;
        #[nN]* ) echo ""
        #break;;
#esac
...
do
                              ...
                              case $actualizar in
			                        [sS]* ) echo ""
                              geany /home/pi/MMDVMHost/MMDVM.ini
			                        break;;
			                        [nN]* ) echo ""
			                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHost/MMDVM.ini /home/pi/MMDVMHost/MMDVM.ini_copia
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHost/MMDVM.ini_copia /home/pi/MMDVMHost/MMDVM.ini
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHost/MMDVM.ini /home/pi/MMDVMHost/MMDVM.ini_copia2
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHost/MMDVM.ini_copia2 /home/pi/MMDVMHost/MMDVM.ini
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHost/MMDVM.ini /home/pi/MMDVMHost/MMDVM.ini_copia3
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHost/MMDVM.ini_copia3 /home/pi/MMDVMHost/MMDVM.ini
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
			...
			[sS]* ) echo ""
                        ...
                        sleep 3
                        sudo cp -f /home/pi/MMDVMHost/MMDVM.ini_original /home/pi/MMDVMHost/MMDVM.ini
			break;;
			[nN]* ) echo ""
			break;;
esac
